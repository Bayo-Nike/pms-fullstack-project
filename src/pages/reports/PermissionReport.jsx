...
export default function PermissionReport({ data = [], loading, onRefresh }) {
  ...
  const columns = useMemo(() => [
    ...
    { accessorKey: "roles", header: "Role List" }
  ], []);
  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center h-[400px] text-slate-500">
        Synchronizing Permission Report Engine...
      </div>
    );
  }
  ...
  return (
    <div className="bg-white rounded-xl border shadow-sm">
      ...
      <div className="p-5 border-b flex justify-between items-center">
        <div>
          <h1 className="text-lg font-bold">Permission Master Report</h1>
        ...
        <div className="flex gap-3">
          ...
          {/* Export */}
          <button
            onClick={() => exportToExcel(columns, data, "Permission_Report")}
          ...
          <button
            onClick={() => exportToPDF(columns, data, "Permission_Report")}
