...
export default function DivisionReport({ data = [], loading, onRefresh }) {
  ...
  const columns = useMemo(() => [
    ...
    { accessorKey: "parentDivision", header: "Parent Division" },
    {
    ...
    { accessorKey: "childList", header: "Child Divisions" }
  ], []);
  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center h-[400px] text-slate-500">
        Synchronizing Division Report Engine...
      </div>
    );
  }
  ...
  return (
    <div className="bg-white rounded-xl border shadow-sm">
      ...
      <div className="p-5 border-b flex justify-between items-center">
        <div>
          <h1 className="text-lg font-bold">Division Master Report</h1>
          <p className="text-xs text-slate-400">Enterprise Organization</p>
        </div>
        ...
        <div className="flex gap-3">
          ...
          {/* Export */}
          <button
            onClick={() => exportToExcel(columns, data, "Division_Report")}
          ...
          <button
            onClick={() => exportToPDF(columns, data, "Division_Report")}
