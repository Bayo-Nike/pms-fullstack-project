...
export default function AuditLogReport({ data = [], loading, onRefresh }) {
  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center h-[400px] text-slate-500">
        Synchronizing Audit Log Report Engine...
      </div>
    );
  }
  ...
  return (
    <div className="bg-white rounded-xl border shadow-sm">
      ...
      <div className="p-5 border-b flex justify-between items-center">
        <div>
          <h1 className="text-lg font-bold">Audit Log Report</h1>
          <p className="text-xs text-slate-400">System Audit Logs</p>
        </div>
        ...
        <div className="flex gap-3">
          ...
          {/* Export */}
          <button
            onClick={() => exportToExcel(columns, data, "AuditLog_Report")}
          ...
          <button
            onClick={() => exportToPDF(columns, data, "AuditLog_Report")}
