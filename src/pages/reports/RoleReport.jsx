...
export default function RoleReport({ data = [], loading, onRefresh }) {
  ...
  const columns = useMemo(() => [
    ...
    },
    {
        ...
        enableSorting: true,
        cell: ({ getValue }) => (
          <span className="px-2 py-1 text-xs font-semibold bg-sky-100 text-sky-700 rounded">
            {getValue()}
          </span>
        )
      },
  
      {
        ...
        enableSorting: false,
        cell: ({ getValue }) => (
            <div className="max-w-[350px] max-h-[60px] overflow-y-auto text-xs text-slate-600">
              {getValue()}
            </div>
          )
      }
  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center h-[400px] text-slate-500">
        Synchronizing Role Report Engine...
      </div>
    );
  }
    ...
    <div className="bg-white rounded-xl border shadow-sm">
      ...
      <div className="p-5 border-b flex justify-between items-center">
        ...
        <div className="flex gap-3">
          ...
          <button
            onClick={() => exportToExcel(columns, data, "Role_Report")}
          ...
          <button
            onClick={() => exportToPDF(columns, data, "Role_Report")}
