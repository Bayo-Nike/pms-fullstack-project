            ...
            <div className="bg-white rounded-xl border border-slate-100 shadow-sm overflow-hidden">
                <div className="p-6 border-b border-slate-50 bg-slate-50/20 grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input className="w-full text-sm font-semibold bg-white border border-slate-200 rounded-lg px-4 py-3 outline-none focus:border-[#0284C7] transition-all" placeholder="e.g. FINANCE_DIRECTOR" value={roleName} onChange={(e) => setRoleName(e.target.value)} />
                    </div>
                    <div>
                        <label className="text-[9px] font-bold uppercase text-slate-400 tracking-widest block mb-2 ml-1">System Description</label>
                        <input className="w-full text-sm font-semibold bg-white border border-slate-200 rounded-lg px-4 py-3 outline-none focus:border-[#0284C7] transition-all" placeholder="e.g. Executive role for budgeting" value={description} onChange={(e) => setDescription(e.target.value)} />
                    </div>
                </div>
