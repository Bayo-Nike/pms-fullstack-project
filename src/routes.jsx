  ...
  return (
    <Routes>
      ...
      <Route path="/" element={<ProtectedRoute><Layout /></ProtectedRoute>}>
        ...
        {/* 5. Planning */}
        <Route path="ColorCodings" element={protect(<ColorCodings />, "CAN_SEE_COLOR_CODING_LIST")} />
        <Route path="ColorCodings/create" element={protect(<CreateColorCoding />, "CAN_REGISTER_COLOR_CODING")} />
        <Route path="ColorCodings/edit/:id" element={protect(<CreateColorCoding />, "CAN_EDIT_COLOR_CODING")} />
        <Route path="ColorCodings/details/:id" element={protect(<ColorCodingDetails />, "CAN_VIEW_COLOR_CODING")} />
